...
class V_billClass(ctk.CTk):
    def __init__(self,root):
        ...
        #========================Bill List=======================
        vbill_list_frame=ctk.CTkFrame(self.root,width=screen_width+100,height=600)
        vbill_list_frame.place(x=50,y=140)
        
        scrolly=Scrollbar(vbill_list_frame,orient=VERTICAL)
        self.v_bill_list=Listbox(vbill_list_frame,font=("goudy old style",15),bg="white",yscrollcommand=scrolly.set)
        ...
        #===============BILL AREA==============
        bill_x_position=screen_width-1050
        bill_y_position=screen_height-630
        vbill_frame=ctk.CTkFrame(self.root)
        vbill_frame.place(x=bill_x_position,y=140)
        
        lbl_title2=Label(vbill_frame,text="Patient Bill Area",font=("goudy old style",20),width=int(screen_width/2-700+50)).pack(side=TOP,fill=X)
        
        
        scrolly2=Scrollbar(vbill_frame,orient=VERTICAL)
        self.bill_area=ctk.CTkTextbox(vbill_frame,bg_color="lightyellow",yscrollcommand=scrolly2.set)
        ...
        lbl_image.place(x=screen_width-500,y=140)
